...
const features = [
  {
    ...
    description: "Get an AI-powered ATS score and improvement tips for your resume.",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Identify missing skills for your target job and get a learning plan.",
    icon: Target,
